...
$(function () {
    ...
    */
    ...
    function $_taskSortable() {
        $('[data-sortable="true"]').sortable({
            ...
            stop: function (event, ui) {
                ...
                var lead_id = ui.item.data('id');
                var status_id = ui.item.parents('.lead-status-card').data('status-id');
                console.log("stop");
                console.log(lead_id);
                console.log(status_id);
                $_updateLeadMoveStatus(lead_id, status_id);
            },
            update: function (event, ui) {
                console.log(event);
                console.log("update");
                console.log(ui);
                // var parent_ui = ui.item.parent().attr('data-id');
                // $_updateLeadMoveStatus(lead_id, status_id);
            }
        });
    ...
    function $_updateLeadMoveStatus(lead_id = 0, status_id = 0) {
        if (lead_id && status_id) {
            //ajax call

            var path = "lead_statusboard/update_status";
