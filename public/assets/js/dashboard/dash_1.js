try {
  ...
  */
  ...
  /*
      ===========================================
          Load lead count on date change picker
      ===========================================
  */
  ...
  var f3 = flatpickr(document.getElementById('rangeCalendarFlatpickr'), {
    ...
    onValueUpdate: function () {
      var current_date = $("#rangeCalendarFlatpickr").val();

      if (current_date.includes("to")) {
        ...
        $.ajax({
          ...
          success: function (data) {
            var status_count = data['status_count'];
            var status_name = data['status_name'];
            var color_code = data['status_color'];
